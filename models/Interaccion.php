...
class Interaccion
{
    ...
    public function modificarInteraccion($id_interaccion, $data)
    {
        ...
        // Actualizar la interacción con los nuevos datos
        $query = "UPDATE Interaccion 
              SET fecha_interaccion = :fecha_interaccion, 
                  nota_interaccion = :nota_interaccion, 
                  id_paciente = :id_paciente, 
                  id_usuario = :id_usuario, 
                  id_tipoInteraccion = :id_tipoInteraccion 
        ...
        $stmt->bindParam(":id_usuario", $usuario['id_usuario']);
        $stmt->bindParam(":id_tipoInteraccion", $tipoInteraccion['id_tipoInteraccion']);
        $stmt->bindParam(":id_interaccion", $id_interaccion, PDO::PARAM_INT);

        // Ejecutar la consulta
        if (!$stmt->execute()) {
            throw new Exception("Error al modificar la interacción");
        }
        return true;
    }
